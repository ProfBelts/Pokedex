...
# get_pokemon_name('charmander')



# def main():
#     if len(sys.argv) > 2:
#         print("Please insert the name of your Pokemon")
#         return 
...
#     if not pokemon_data:
#         print(f"Pokemon: {pokemon_name} data not found")
#         return

#     print(f"Pokemon Name: {get_pokemon_data(get_pokemon_name)}")
